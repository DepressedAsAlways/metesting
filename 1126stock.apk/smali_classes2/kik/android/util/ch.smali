...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        ...
        Lkik/android/util/ch$c;,
        Lkik/android/util/ch$d;,
        Lkik/android/util/ch$b;
    }
.end annotation
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lkik/android/util/ch;->a:Ljava/lang/String;
...
.method public static a(Landroid/view/View;ILandroid/animation/ValueAnimator$AnimatorUpdateListener;Landroid/animation/Animator$AnimatorListener;JJ)Landroid/animation/Animator;
    ...
    .line 818
    invoke-static {p0, p2}, Lkik/android/util/ch;->a(Landroid/view/View;Landroid/animation/ValueAnimator$AnimatorUpdateListener;)Landroid/animation/ValueAnimator$AnimatorUpdateListener;
...
.method private static a(Landroid/view/View;Landroid/animation/ValueAnimator$AnimatorUpdateListener;)Landroid/animation/ValueAnimator$AnimatorUpdateListener;
    ...
    .line 884
    invoke-static {v0, p0, p1}, Lkik/android/util/cj;->a(Landroid/view/ViewGroup$MarginLayoutParams;Landroid/view/View;Landroid/animation/ValueAnimator$AnimatorUpdateListener;)Landroid/animation/ValueAnimator$AnimatorUpdateListener;
...
.method public static a(Landroid/view/View;ILandroid/animation/AnimatorListenerAdapter;)Landroid/animation/ValueAnimator;
    ...
    .line 854
    invoke-static {p0, p1, v0, v0}, Lkik/android/util/ch;->a(Landroid/view/View;ILandroid/animation/ValueAnimator$AnimatorUpdateListener;Landroid/animation/Animator$AnimatorListener;)Landroid/animation/ValueAnimator;
...
.method public static a(Landroid/view/View;)Lkik/android/util/ch$b;
    .locals 2

    .prologue
    .line 279
    new-instance v0, Lkik/android/util/ch$b;

    const/4 v1, 0x0

    invoke-direct {v0, p0, v1}, Lkik/android/util/ch$b;-><init>(Landroid/view/View;B)V

    return-object v0
.end method

.method public static a(Lkik/core/datatypes/messageExtensions/ContentMessage;Landroid/content/Context;Ljava/lang/String;)Lkik/android/util/ch$c;
    .locals 9
    ...
    sget-object v3, Lkik/android/util/ch;->a:Ljava/lang/String;
    ...
    invoke-static {v0}, Lkik/android/util/ch;->a(Lkik/core/datatypes/r;)Landroid/graphics/Bitmap;
    ...
    .line 419
    :cond_9
    new-instance v2, Lkik/android/util/ch$c;

    invoke-direct {v2, v1, v3, v0, v4}, Lkik/android/util/ch$c;-><init>(Ljava/lang/String;Ljava/lang/String;Landroid/graphics/Bitmap;Lcom/kik/contentlink/model/attachments/ContentUri;)V
...
.method public static a(Landroid/view/View;Landroid/animation/AnimatorListenerAdapter;)V
    ...
    invoke-static {p0, v0, v1, p1}, Lkik/android/util/ch;->a(Landroid/view/View;ILandroid/animation/ValueAnimator$AnimatorUpdateListener;Landroid/animation/Animator$AnimatorListener;)Landroid/animation/ValueAnimator;
    ...
    .line 2841
    new-instance v1, Lkik/android/util/ch$2;

    invoke-direct {v1, p0}, Lkik/android/util/ch$2;-><init>(Landroid/view/View;)V
...
.method public static a(Landroid/widget/EditText;)V
    ...
    new-instance v2, Lkik/android/util/bz$a;

    invoke-direct {v2}, Lkik/android/util/bz$a;-><init>()V
...
.method public static a(Landroid/widget/ScrollView;)V
    ...
    invoke-direct {v0, p0}, Lkik/android/util/ch$1;-><init>(Landroid/widget/ScrollView;)V
...
.method public static b(Landroid/view/View;I)V
    ...
    invoke-virtual {v0, p1}, Lkik/android/util/ch$b;->a(I)Lkik/android/util/ch$b;
...
.method static synthetic b(Landroid/view/View;ILandroid/animation/ValueAnimator$AnimatorUpdateListener;Landroid/animation/Animator$AnimatorListener;JJ)V
    ...
    .line 0
    .line 3808
    invoke-static/range {p0 .. p7}, Lkik/android/util/ch;->a(Landroid/view/View;ILandroid/animation/ValueAnimator$AnimatorUpdateListener;Landroid/animation/Animator$AnimatorListener;JJ)Landroid/animation/Animator;
...
.method public static c(Landroid/view/View;I)V
    ...
    .line 539
    invoke-static {p0, v0, v1, v2, v3}, Lkik/android/util/ch;->a(Landroid/view/View;IIII)V
...
.method public static d(Landroid/view/View;)V
    ...
    .line 3073
    :cond_4
    invoke-static {v0, v3}, Lkik/android/util/ch;->e(Landroid/view/View;I)V
    ...
    invoke-static {v0}, Lkik/android/util/ch;->a(Landroid/view/View;)Lkik/android/util/ch$b;

    move-result-object v0

    invoke-virtual {v0}, Lkik/android/util/ch$b;->a()Lkik/android/util/ch$b;

    move-result-object v0

    invoke-virtual {v0, v3}, Lkik/android/util/ch$b;->a(I)Lkik/android/util/ch$b;

    move-result-object v0

    invoke-virtual {v0, v3}, Lkik/android/util/ch$b;->b(I)Lkik/android/util/ch$b;

    move-result-object v0

    invoke-virtual {v0, v3}, Lkik/android/util/ch$b;->c(I)Lkik/android/util/ch$b;
...
.method public static f(Landroid/view/View;I)V
    ...
    .line 808
    invoke-static {p0, p1}, Lkik/android/util/ci;->a(Landroid/view/View;I)Ljava/lang/Runnable;
