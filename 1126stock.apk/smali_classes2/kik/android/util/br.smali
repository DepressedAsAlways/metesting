...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lkik/android/util/br;->a:Ljava/util/Set;
    ...
    sput-object v0, Lkik/android/util/br;->b:Ljava/util/Set;
    ...
    sput-object v0, Lkik/android/util/br;->c:Ljava/util/List;
...
.method private constructor <init>(Landroid/content/Context;Landroid/graphics/Bitmap;Lcom/kik/android/Mixpanel;Lkik/core/datatypes/ad;Lkik/core/interfaces/b;)V
    ...
    .line 202
    iput-object p1, p0, Lkik/android/util/br;->e:Landroid/content/Context;

    .line 203
    iput-object p2, p0, Lkik/android/util/br;->f:Landroid/graphics/Bitmap;

    .line 204
    iput-object p3, p0, Lkik/android/util/br;->d:Lcom/kik/android/Mixpanel;

    .line 205
    iput-object p4, p0, Lkik/android/util/br;->g:Lkik/core/datatypes/ad;

    .line 206
    iput-object p5, p0, Lkik/android/util/br;->h:Lkik/core/interfaces/b;
...
.method static synthetic a(Lkik/android/util/br;)Lcom/kik/android/Mixpanel;
    .locals 1

    .prologue
    .line 48
    iget-object v0, p0, Lkik/android/util/br;->d:Lcom/kik/android/Mixpanel;
...
.method private a()Ljava/util/List;
    ...
    .line 294
    iget-object v1, p0, Lkik/android/util/br;->e:Landroid/content/Context;
    ...
    .line 295
    sget-object v1, Lkik/android/util/br;->a:Ljava/util/Set;

    invoke-static {v0, v1}, Lkik/android/util/br;->a(Ljava/util/List;Ljava/util/Collection;)V
...
.method static synthetic a(Ljava/lang/String;Ljava/lang/String;)Lkik/android/util/bt;
    .locals 5
    ...
    invoke-direct {v3, v0, v2, v1}, Lkik/android/util/bt;-><init>(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
...
.method public static a(Lkik/android/chat/fragment/KikScopedDialogFragment;Ljava/lang/String;Lkik/core/datatypes/ad;Landroid/content/Context;Lcom/kik/android/Mixpanel;Lkik/core/interfaces/b;Lcom/kik/cache/ae;)V
    .locals 9
    ...
    .line 90
    invoke-static/range {v0 .. v6}, Lkik/android/util/bs;->a(Lkik/android/chat/fragment/KikScopedDialogFragment;Lkik/core/datatypes/ad;Lcom/kik/android/Mixpanel;Ljava/lang/String;Landroid/content/Context;Lkik/core/interfaces/b;Lcom/kik/cache/ae;)Landroid/content/DialogInterface$OnClickListener;
...
.method static synthetic a(Lkik/android/chat/fragment/KikScopedDialogFragment;Lkik/core/datatypes/ad;Lcom/kik/android/Mixpanel;Ljava/lang/String;Landroid/content/Context;Lkik/core/interfaces/b;Lcom/kik/cache/ae;I)V
    .locals 3
    ...
    invoke-virtual {p0, v1, v2}, Lkik/android/chat/fragment/KikScopedDialogFragment;->a(Landroid/content/Context;I)Lcom/kik/events/Promise;
    ...
    .line 5109
    :cond_2
    invoke-static {p1, p4, p2, p5, p6}, Lkik/android/util/br;->a(Lkik/core/datatypes/ad;Landroid/content/Context;Lcom/kik/android/Mixpanel;Lkik/core/interfaces/b;Lcom/kik/cache/ae;)V
...
.method static synthetic a(Lkik/android/util/br;Landroid/content/pm/ResolveInfo;Landroid/net/Uri;Lkik/android/util/bt;)V
    .locals 4
    ...
    invoke-virtual {p3}, Lkik/android/util/bt;->b()Ljava/lang/String;
    ...
    .line 4394
    invoke-virtual {p3}, Lkik/android/util/bt;->c()Ljava/lang/String;
    ...
    .line 4408
    :goto_0
    iget-object v0, p0, Lkik/android/util/br;->e:Landroid/content/Context;
    ...
    invoke-virtual {p3}, Lkik/android/util/bt;->a()Ljava/lang/String;
...
.method static synthetic a(Lkik/android/util/br;Landroid/content/pm/ResolveInfo;Lkik/android/util/bt;)V
    .locals 4
    ...
    invoke-virtual {p2}, Lkik/android/util/bt;->b()Ljava/lang/String;
    ...
    invoke-virtual {p2}, Lkik/android/util/bt;->c()Ljava/lang/String;
    ...
    invoke-virtual {p2}, Lkik/android/util/bt;->a()Ljava/lang/String;
...
.method static synthetic a(Lkik/android/util/br;Ljava/lang/String;Landroid/content/pm/ResolveInfo;)V
    .locals 3
...
.method private a(Lkik/android/util/bt;Ljava/lang/String;)V
    .locals 7

    .prologue
    .line 363
    iget-object v0, p0, Lkik/android/util/br;->f:Landroid/graphics/Bitmap;

    iget-object v1, p0, Lkik/android/util/br;->g:Lkik/core/datatypes/ad;

    iget-object v1, v1, Lkik/core/datatypes/ad;->c:Ljava/lang/String;

    invoke-static {v0, v1}, Lkik/android/util/br;->a(Landroid/graphics/Bitmap;Ljava/lang/String;)Landroid/net/Uri;

    move-result-object v4

    .line 364
    invoke-direct {p0}, Lkik/android/util/br;->a()Ljava/util/List;
    ...
    iget-object v2, p0, Lkik/android/util/br;->e:Landroid/content/Context;
    ...
    .line 369
    new-instance v0, Lkik/android/util/br$3;
    ...
    invoke-direct/range {v0 .. v5}, Lkik/android/util/br$3;-><init>(Lkik/android/util/br;Lcom/kik/view/adapters/v;Ljava/lang/String;Landroid/net/Uri;Lkik/android/util/bt;)V
...
.method public static a(Lkik/core/datatypes/ad;Landroid/content/Context;Lcom/kik/android/Mixpanel;Lkik/core/interfaces/b;Landroid/graphics/Bitmap;Ljava/lang/String;)V
    ...
    .line 152
    invoke-static {p0, p1}, Lkik/android/util/br;->a(Lkik/core/datatypes/ad;Landroid/content/Context;)Z
    ...
    invoke-direct/range {v0 .. v5}, Lkik/android/util/br;-><init>(Landroid/content/Context;Landroid/graphics/Bitmap;Lcom/kik/android/Mixpanel;Lkik/core/datatypes/ad;Lkik/core/interfaces/b;)V

    .line 161
    new-instance v1, Lkik/android/util/bt;

    const/4 v2, 0x0

    invoke-direct {v1, v6, v2, v7}, Lkik/android/util/bt;-><init>(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V

    .line 162
    invoke-direct {v0, v1, p5}, Lkik/android/util/br;->a(Lkik/android/util/bt;Ljava/lang/String;)V

    goto :goto_0
.end method

.method public static a(Lkik/core/datatypes/ad;Landroid/content/Context;Lcom/kik/android/Mixpanel;Lkik/core/interfaces/b;Lcom/kik/cache/ae;)V
    .locals 9
    ...
    :cond_0
    :try_start_0
    invoke-static {p0, p1, p4}, Lkik/android/util/f;->a(Lkik/core/datatypes/ad;Landroid/content/Context;Lcom/kik/cache/ae;)Landroid/graphics/Bitmap;
    ...
    .line 146
    new-instance v2, Lkik/android/util/bt;

    invoke-direct {v2, v6, v7, v8}, Lkik/android/util/bt;-><init>(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V

    .line 1270
    iget-object v1, v0, Lkik/android/util/br;->f:Landroid/graphics/Bitmap;

    iget-object v3, v0, Lkik/android/util/br;->g:Lkik/core/datatypes/ad;

    iget-object v3, v3, Lkik/core/datatypes/ad;->c:Ljava/lang/String;

    invoke-static {v1, v3}, Lkik/android/util/br;->a(Landroid/graphics/Bitmap;Ljava/lang/String;)Landroid/net/Uri;

    move-result-object v3

    .line 1271
    invoke-direct {v0}, Lkik/android/util/br;->a()Ljava/util/List;
    ...
    iget-object v6, v0, Lkik/android/util/br;->e:Landroid/content/Context;
    ...
    iget-object v1, v0, Lkik/android/util/br;->e:Landroid/content/Context;
    ...
    .line 1276
    new-instance v1, Lkik/android/util/br$2;

    invoke-direct {v1, v0, v6, v3, v2}, Lkik/android/util/br$2;-><init>(Lkik/android/util/br;Lcom/kik/view/adapters/v;Landroid/net/Uri;Lkik/android/util/bt;)V
...
.method public static a(Lkik/core/datatypes/ad;Landroid/content/Context;Lcom/kik/android/Mixpanel;Lkik/core/interfaces/b;Lcom/kik/events/Promise;Lkik/android/e/i;Ljava/lang/String;)V
    ...
    .line 2304
    iget-object v2, v0, Lkik/android/util/br;->e:Landroid/content/Context;
    ...
    .line 2305
    sget-object v2, Lkik/android/util/br;->b:Ljava/util/Set;

    invoke-static {v1, v2}, Lkik/android/util/br;->a(Ljava/util/List;Ljava/util/Collection;)V

    .line 2306
    sget-object v2, Lkik/android/util/br;->c:Ljava/util/List;

    invoke-static {v1, v2}, Lkik/android/util/br;->a(Ljava/util/List;Ljava/util/List;)Ljava/util/List;
    ...
    iget-object v3, v0, Lkik/android/util/br;->e:Landroid/content/Context;
    ...
    .line 2216
    new-instance v1, Lkik/android/util/br$1;
    ...
    invoke-direct/range {v1 .. v6}, Lkik/android/util/br$1;-><init>(Lkik/android/util/br;Lcom/kik/view/adapters/v;Lkik/android/e/i;Lcom/kik/events/Promise;Ljava/lang/String;)V
