.class final Lkik/android/util/ay$1;
...
.method constructor <init>(Lkik/android/util/ay;)V
    ...
    .prologue
    .line 87
    iput-object p1, p0, Lkik/android/util/ay$1;->a:Lkik/android/util/ay;
...
.method public final synthetic a(Ljava/lang/Object;Ljava/lang/Object;)V
    ...
    iget-object v4, p0, Lkik/android/util/ay$1;->a:Lkik/android/util/ay;

    invoke-static {v4}, Lkik/android/util/ay;->a(Lkik/android/util/ay;)Lcom/kik/android/Mixpanel;

    move-result-object v4

    iget-object v5, p0, Lkik/android/util/ay$1;->a:Lkik/android/util/ay;

    invoke-static {v5}, Lkik/android/util/ay;->b(Lkik/android/util/ay;)Lkik/core/net/e;

    move-result-object v5

    iget-object v6, p0, Lkik/android/util/ay$1;->a:Lkik/android/util/ay;

    invoke-static {v6}, Lkik/android/util/ay;->c(Lkik/android/util/ay;)Lkik/core/interfaces/o;

    move-result-object v6

    iget-object v7, p0, Lkik/android/util/ay$1;->a:Lkik/android/util/ay;

    invoke-static {v7}, Lkik/android/util/ay;->d(Lkik/android/util/ay;)Lkik/core/interfaces/ac;

    move-result-object v7

    iget-object v8, p0, Lkik/android/util/ay$1;->a:Lkik/android/util/ay;

    invoke-static {v8}, Lkik/android/util/ay;->e(Lkik/android/util/ay;)Lkik/core/interfaces/j;

    move-result-object v8

    iget-object v9, p0, Lkik/android/util/ay$1;->a:Lkik/android/util/ay;

    invoke-static {v9}, Lkik/android/util/ay;->f(Lkik/android/util/ay;)Lkik/core/interfaces/y;
    ...
    .line 1100
    :cond_0
    iget-object v0, p0, Lkik/android/util/ay$1;->a:Lkik/android/util/ay;

    invoke-virtual {v0, p2}, Lkik/android/util/ay;->b(Lkik/core/datatypes/Message;)V
