.class public final Lkik/android/net/communicator/c;
.super Ljava/lang/Object;
.source "SourceFile"

# interfaces
.implements Lkik/android/net/communicator/b$a;


# annotations
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lkik/android/net/communicator/c$a;
    }
.end annotation
...
.field private i:Lkik/android/net/communicator/b;
...
.field private q:Lkik/android/net/communicator/c$a;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lkik/android/net/communicator/c;->n:Lorg/slf4j/b;
    ...
    sput-object v0, Lkik/android/net/communicator/c;->o:Landroid/net/SSLCertificateSocketFactory;
    ...
    sput-object v0, Lkik/android/net/communicator/c;->p:Ljavax/net/ssl/HostnameVerifier;

    .line 100
    return-void
.end method

.method public constructor <init>(Lkik/android/net/communicator/b;Lcom/kik/android/a/a;Ljava/lang/String;Ljava/lang/String;)V
    .locals 3
    ...
    iput-wide v0, p0, Lkik/android/net/communicator/c;->e:J

    .line 125
    iput-object p1, p0, Lkik/android/net/communicator/c;->i:Lkik/android/net/communicator/b;

    .line 126
    iput-object p2, p0, Lkik/android/net/communicator/c;->j:Lcom/kik/android/a/a;

    .line 127
    iput-object p4, p0, Lkik/android/net/communicator/c;->l:Ljava/lang/String;
    ...
    .line 132
    :cond_0
    new-instance v0, Lkik/android/net/communicator/c$a;

    invoke-direct {v0, p0}, Lkik/android/net/communicator/c$a;-><init>(Lkik/android/net/communicator/c;)V

    iput-object v0, p0, Lkik/android/net/communicator/c;->q:Lkik/android/net/communicator/c$a;

    .line 134
    iput-object p3, p0, Lkik/android/net/communicator/c;->k:Ljava/lang/String;
...
.method private a(J)V
    ...
    iput-wide v0, p0, Lkik/android/net/communicator/c;->f:J
...
.method private a(Ljava/lang/String;IZ)V
    ...
    .line 156
    sget-object v0, Lkik/android/net/communicator/c;->o:Landroid/net/SSLCertificateSocketFactory;
    ...
    .line 159
    iput-object v0, p0, Lkik/android/net/communicator/c;->g:Ljava/net/Socket;

    .line 160
    iget-object v1, p0, Lkik/android/net/communicator/c;->g:Ljava/net/Socket;
    ...
    .line 176
    sget-object v1, Lkik/android/net/communicator/c;->p:Ljavax/net/ssl/HostnameVerifier;
...
.method private a(Lkik/core/net/security/StreamSecurityType;)V
    ...
    .line 298
    :goto_0
    iget-object v1, p0, Lkik/android/net/communicator/c;->b:Lkik/core/net/g;
    ...
    .line 304
    invoke-virtual {p0}, Lkik/android/net/communicator/c;->a()V
    ...
    .line 311
    iget-object v2, p0, Lkik/android/net/communicator/c;->b:Lkik/core/net/g;
    ...
    .line 312
    iget-object v3, p0, Lkik/android/net/communicator/c;->b:Lkik/core/net/g;
    ...
    .line 316
    iget-object v4, p0, Lkik/android/net/communicator/c;->b:Lkik/core/net/g;
    ...
    .line 343
    iget-object v0, p0, Lkik/android/net/communicator/c;->b:Lkik/core/net/g;
    ...
    .line 352
    invoke-direct {p0, v0, v1}, Lkik/android/net/communicator/c;->a(J)V
...
.method private a(Z)V
    ...
    .line 399
    :cond_0
    iget-object v0, p0, Lkik/android/net/communicator/c;->d:Lkik/android/net/b;

    if-eqz v0, :cond_2

    .line 400
    iget-object v0, p0, Lkik/android/net/communicator/c;->a:Lkik/core/net/h;
...
.method private b(Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-object v1, p0, Lkik/android/net/communicator/c;->l:Ljava/lang/String;
...
.method public final a()V
    ...
    .prologue
    .line 411
    iget-object v0, p0, Lkik/android/net/communicator/c;->h:Lkik/android/net/a;
...
.method public final a(Ljava/lang/String;)V
    ...
    invoke-direct {p0, v0}, Lkik/android/net/communicator/c;->a(Z)V
...
.method public final a(Ljava/lang/String;ILjava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Lkik/core/net/security/StreamSecurityType;I)V
    ...
    invoke-direct {p0, p1, p2, v3}, Lkik/android/net/communicator/c;->a(Ljava/lang/String;IZ)V
    ...
    iput-object v4, p0, Lkik/android/net/communicator/c;->m:Ljava/lang/String;
    ...
    .line 7213
    iget-object v2, p0, Lkik/android/net/communicator/c;->m:Ljava/lang/String;

    invoke-direct {p0, v3}, Lkik/android/net/communicator/c;->b(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v7

    iget-object v11, p0, Lkik/android/net/communicator/c;->k:Ljava/lang/String;
    ...
    .line 7224
    iget-object v2, p0, Lkik/android/net/communicator/c;->g:Ljava/net/Socket;
    ...
    iget-object v10, p0, Lkik/android/net/communicator/c;->g:Ljava/net/Socket;
    ...
    iput-object v2, p0, Lkik/android/net/communicator/c;->d:Lkik/android/net/b;

    .line 7230
    iput-object v8, p0, Lkik/android/net/communicator/c;->c:Ljava/io/InputStream;

    .line 7231
    iget-object v2, p0, Lkik/android/net/communicator/c;->d:Lkik/android/net/b;
    ...
    iget-object v4, p0, Lkik/android/net/communicator/c;->c:Ljava/io/InputStream;
    ...
    iget-object v5, p0, Lkik/android/net/communicator/c;->j:Lcom/kik/android/a/a;

    invoke-direct {v2, v3, v4, v5}, Lkik/android/net/a;-><init>(Ljava/io/Reader;Ljava/lang/String;Lcom/kik/android/a/a;)V

    iput-object v2, p0, Lkik/android/net/communicator/c;->h:Lkik/android/net/a;
    ...
    iput-object v2, p0, Lkik/android/net/communicator/c;->b:Lkik/core/net/g;

    .line 7289
    iget-object v2, p0, Lkik/android/net/communicator/c;->b:Lkik/core/net/g;

    iget-object v3, p0, Lkik/android/net/communicator/c;->h:Lkik/android/net/a;
    ...
    iput-object v2, p0, Lkik/android/net/communicator/c;->a:Lkik/core/net/h;

    .line 7291
    iget-object v2, p0, Lkik/android/net/communicator/c;->a:Lkik/core/net/h;

    iget-object v3, p0, Lkik/android/net/communicator/c;->d:Lkik/android/net/b;
    ...
    invoke-direct {p0, v2}, Lkik/android/net/communicator/c;->a(Z)V

    .line 520
    move-object/from16 v0, p9

    invoke-direct {p0, v0}, Lkik/android/net/communicator/c;->a(Lkik/core/net/security/StreamSecurityType;)V
    ...
    .line 8379
    iget-object v2, p0, Lkik/android/net/communicator/c;->i:Lkik/android/net/communicator/b;

    iget-object v3, p0, Lkik/android/net/communicator/c;->b:Lkik/core/net/g;

    invoke-virtual {v2, v3, p0}, Lkik/android/net/communicator/b;->a(Lkik/core/net/g;Lkik/android/net/communicator/b$a;)V

    .line 8380
    new-instance v2, Ljava/lang/Thread;

    iget-object v3, p0, Lkik/android/net/communicator/c;->i:Lkik/android/net/communicator/b;
    ...
    invoke-direct {p0, v3}, Lkik/android/net/communicator/c;->a(Z)V

    .line 533
    invoke-virtual {p0}, Lkik/android/net/communicator/c;->a()V

    .line 534
    invoke-virtual {p0}, Lkik/android/net/communicator/c;->c()V
    ...
    iput-object v3, p0, Lkik/android/net/communicator/c;->g:Ljava/net/Socket;

    .line 7143
    iget-object v3, p0, Lkik/android/net/communicator/c;->g:Ljava/net/Socket;
    ...
    .line 7217
    iget-object v4, p0, Lkik/android/net/communicator/c;->m:Ljava/lang/String;

    invoke-direct {p0, v2}, Lkik/android/net/communicator/c;->b(Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-object v7, p0, Lkik/android/net/communicator/c;->g:Ljava/net/Socket;
    ...
    iput-object v3, p0, Lkik/android/net/communicator/c;->d:Lkik/android/net/b;
    ...
    iput-object v2, p0, Lkik/android/net/communicator/c;->c:Ljava/io/InputStream;
...
.method public final a(Lkik/core/net/outgoing/af;)V
    ...
    .line 566
    iget-object v3, p0, Lkik/android/net/communicator/c;->q:Lkik/android/net/communicator/c$a;
    ...
    invoke-virtual {v3}, Lkik/android/net/communicator/c$a;->reset()V
    ...
    .line 589
    iget-object v2, p0, Lkik/android/net/communicator/c;->q:Lkik/android/net/communicator/c$a;

    invoke-virtual {v2}, Lkik/android/net/communicator/c$a;->b()I
    ...
    invoke-virtual {v3}, Lkik/android/net/communicator/c$a;->a()[B

    move-result-object v3

    iget-object v4, p0, Lkik/android/net/communicator/c;->q:Lkik/android/net/communicator/c$a;

    invoke-virtual {v4}, Lkik/android/net/communicator/c$a;->b()I
    ...
    invoke-virtual {v2}, Lkik/android/net/communicator/c$a;->reset()V
    ...
    .line 612
    :cond_3
    invoke-direct {p0, v1}, Lkik/android/net/communicator/c;->a(Z)V
...
.method public final b()J
    ...
    .prologue
    .line 368
    iget-wide v0, p0, Lkik/android/net/communicator/c;->f:J
...
.method public final declared-synchronized c()V
    ...
    :try_start_0
    iget-object v0, p0, Lkik/android/net/communicator/c;->i:Lkik/android/net/communicator/b;

    invoke-virtual {v0}, Lkik/android/net/communicator/b;->b()V
    ...
    invoke-virtual {p0, v0}, Lkik/android/net/communicator/c;->a(Ljava/lang/String;)V
    ...
    :try_start_4
    iput-object v0, p0, Lkik/android/net/communicator/c;->d:Lkik/android/net/b;

    .line 9454
    :cond_1
    :goto_1
    iget-object v0, p0, Lkik/android/net/communicator/c;->c:Ljava/io/InputStream;
    :try_end_4
    ...
    :try_start_6
    iput-object v0, p0, Lkik/android/net/communicator/c;->c:Ljava/io/InputStream;

    .line 9466
    :cond_2
    :goto_2
    iget-object v0, p0, Lkik/android/net/communicator/c;->g:Ljava/net/Socket;
    :try_end_6
    ...
    iput-object v1, p0, Lkik/android/net/communicator/c;->d:Lkik/android/net/b;
    ...
    iput-object v1, p0, Lkik/android/net/communicator/c;->c:Ljava/io/InputStream;
    ...
    iput-object v1, p0, Lkik/android/net/communicator/c;->g:Ljava/net/Socket;
...
.method public final d()Ljava/lang/String;
    ...
    .prologue
    .line 629
    iget-object v0, p0, Lkik/android/net/communicator/c;->m:Ljava/lang/String;
...
.method public final f()J
    ...
    .prologue
    .line 646
    iget-wide v0, p0, Lkik/android/net/communicator/c;->e:J
